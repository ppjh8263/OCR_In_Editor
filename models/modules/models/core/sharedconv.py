...
class SharedConv(BaseModel):
    ...
    def __init__(self, bbNet: nn.Module, config):
        ...
        self.mergeLayers1 = HLayer(2048 + 1024, 256)
        self.mergeLayers2 = HLayer(256 + 512, 128)
        self.mergeLayers3 = HLayer(128 + 256, 64)

        self.mergeLayers4 = nn.Conv2d(64, 256, kernel_size = 3, padding = 1)
