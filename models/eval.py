...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', default='saved/scheduler2017/scheduler_best.pth.tar', type=pathlib.Path, required=False, help='path to model')
    parser.add_argument('-o', '--output_dir', default='output/scheduler17', type=pathlib.Path, help='output dir for drawn images')
    parser.add_argument('-i', '--input_dir', default='datasets/test', type=pathlib.Path, required=False, help='dir for input image')
